...
export function decodeCompactSize(offset, bytes) {
...
export function encodeCompactSize(num) {
    if (num <= 252) {
...
export function getCompactVariableSize(num) {
    if (num <= 252) {
        return 1;
    }
    else if (num > 252 && num <= 65535) {
...
export function SHA256RIPEMD160(data) {
    return ripemd160(sha256(data));
}
export function networkValueToEnumValue(value) {
...
export function publicKeyHashToAddress(hash, network = DEFAULT_NETWORK) {
...
export function ipToBytes(ip, compact) {
