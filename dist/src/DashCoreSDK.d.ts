...
export declare class DashCoreSDK {
    ...
    private normalizeInstantLockBytes;
    private getAssetLockTransactionProofData;
     ...
     */
    createInstantAssetLockProof(transaction: Transaction | Uint8Array | string, instantLock: InstantLock | Uint8Array | string, outputIndex?: number): InstantAssetLockProof;
    /**
     * Builds a Core-level chain asset lock proof payload.
     * This uses a numeric `type` field and is not directly compatible
     * with dash-platform-sdk identity create parameters.
     */
    createChainAssetLockProof(transaction: Transaction | Uint8Array | string, coreChainLockedHeight: number, outputIndex?: number): ChainAssetLockProof;
