import { CHANGE_OUTPUT_MAX_SIZE, DEFAULT_NLOCK_TIME, FEE_PER_BYTE, MIN_FEE_RELAY, NLOCK_TIME_BLOCK_BASED_LIMIT, SIGHASH_ALL, SIGNED_INPUT_MAX_SIZE, TRANSACTION_VERSION, TransactionType } from '../constants.js';
